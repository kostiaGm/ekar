<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('hpic')); ?>:</b>
	<?php echo CHtml::encode($data->hpic); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('tube')); ?>:</b>
	<?php echo CHtml::encode($data->tube); ?>
	<br />
